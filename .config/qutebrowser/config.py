...
#
c.colors.statusbar.url.fg = '#0a0a0a'
c.colors.statusbar.url.error.fg = '#0a0a0a'
c.colors.statusbar.url.hover.fg = '#0a0a0a'
c.colors.statusbar.url.warn.fg = '#0a0a0a'
c.colors.statusbar.url.success.http.fg = '#0a0a0a'
c.colors.statusbar.url.success.https.fg = '#0a0a0a'

c.colors.statusbar.normal.bg = '#928071'
c.colors.statusbar.normal.bg = '#928071'
c.colors.statusbar.normal.fg = '#0a0a0a'
c.colors.tabs.bar.bg = 'black'
c.colors.tabs.odd.bg = 'black'
c.colors.tabs.even.bg = 'black'
c.colors.tabs.selected.odd.bg = '#928071'
c.colors.tabs.selected.odd.bg = '#928071'
c.colors.tabs.selected.even.bg = '#928071'
c.colors.tabs.selected.even.bg = '#928071'
c.colors.tabs.selected.odd.fg = '#0a0a0a'
c.colors.tabs.selected.even.fg = '#0a0a0a'

c.colors.tabs.indicator.start = '#928071'
c.colors.tabs.indicator.start = '#928071'
c.colors.tabs.indicator.stop = '#928071'
c.colors.tabs.indicator.stop = '#928071'
#c.colors.tabs.indicator.error = '#928071'
#c.colors.tabs.indicator.error = '#928071'
#c.colors.tabs.indicator.system = '#928071'
#c.colors.tabs.indicator.system = '#928071'
