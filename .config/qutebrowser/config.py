...
#
c.colors.statusbar.url.fg = '#080b0b'
c.colors.statusbar.url.error.fg = '#080b0b'
c.colors.statusbar.url.hover.fg = '#080b0b'
c.colors.statusbar.url.warn.fg = '#080b0b'
c.colors.statusbar.url.success.http.fg = '#080b0b'
c.colors.statusbar.url.success.https.fg = '#080b0b'

c.colors.statusbar.normal.bg = '#9c9464'
c.colors.statusbar.normal.bg = '#9c9464'
c.colors.statusbar.normal.fg = '#080b0b'
c.colors.tabs.bar.bg = 'black'
c.colors.tabs.odd.bg = 'black'
c.colors.tabs.even.bg = 'black'
c.colors.tabs.selected.odd.bg = '#9c9464'
c.colors.tabs.selected.odd.bg = '#9c9464'
c.colors.tabs.selected.even.bg = '#9c9464'
c.colors.tabs.selected.even.bg = '#9c9464'
c.colors.tabs.selected.odd.fg = '#080b0b'
c.colors.tabs.selected.even.fg = '#080b0b'

c.colors.tabs.indicator.start = '#9c9464'
c.colors.tabs.indicator.start = '#9c9464'
c.colors.tabs.indicator.stop = '#9c9464'
c.colors.tabs.indicator.stop = '#9c9464'
#c.colors.tabs.indicator.error = '#9c9464'
#c.colors.tabs.indicator.error = '#9c9464'
#c.colors.tabs.indicator.system = '#9c9464'
#c.colors.tabs.indicator.system = '#9c9464'
