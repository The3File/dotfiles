...
c.colors.tabs.selected.odd.bg = '#0066ff'
c.colors.tabs.selected.odd.bg = '#0066ff'
c.colors.tabs.selected.even.bg = '#0066ff'
c.colors.tabs.selected.even.bg = '#0066ff'
c.colors.tabs.selected.odd.fg = '#000000'
c.colors.tabs.selected.even.fg = '#000000'

c.colors.tabs.indicator.start = '#0066ff'
c.colors.tabs.indicator.start = '#0066ff'
c.colors.tabs.indicator.stop = '#0066ff'
c.colors.tabs.indicator.stop = '#0066ff'
#c.colors.tabs.indicator.error = '#0066ff'
#c.colors.tabs.indicator.error = '#0066ff'
#c.colors.tabs.indicator.system = '#0066ff'
#c.colors.tabs.indicator.system = '#0066ff'
