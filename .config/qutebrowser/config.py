...
#
c.colors.statusbar.url.fg = '#070709'
c.colors.statusbar.url.error.fg = '#070709'
c.colors.statusbar.url.hover.fg = '#070709'
c.colors.statusbar.url.warn.fg = '#070709'
c.colors.statusbar.url.success.http.fg = '#070709'
c.colors.statusbar.url.success.https.fg = '#070709'

c.colors.statusbar.normal.bg = '#6a5c7a'
c.colors.statusbar.normal.bg = '#6a5c7a'
c.colors.statusbar.normal.fg = '#070709'
c.colors.tabs.bar.bg = 'black'
c.colors.tabs.odd.bg = 'black'
c.colors.tabs.even.bg = 'black'
c.colors.tabs.selected.odd.bg = '#6a5c7a'
c.colors.tabs.selected.odd.bg = '#6a5c7a'
c.colors.tabs.selected.even.bg = '#6a5c7a'
c.colors.tabs.selected.even.bg = '#6a5c7a'
c.colors.tabs.selected.odd.fg = '#070709'
c.colors.tabs.selected.even.fg = '#070709'

c.colors.tabs.indicator.start = '#6a5c7a'
c.colors.tabs.indicator.start = '#6a5c7a'
c.colors.tabs.indicator.stop = '#6a5c7a'
c.colors.tabs.indicator.stop = '#6a5c7a'
#c.colors.tabs.indicator.error = '#6a5c7a'
#c.colors.tabs.indicator.error = '#6a5c7a'
#c.colors.tabs.indicator.system = '#6a5c7a'
#c.colors.tabs.indicator.system = '#6a5c7a'
